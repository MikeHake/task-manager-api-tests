...
public class ProjectSteps extends ThucydidesRestAssuredTestSteps {
    ...
    public void verifyProjectColectionURLs() {
        ...
        response.then().assertThat().statusCode(200);
        ProjectCollection collection = response.as(ProjectCollection.class);
        Assert.assertEquals("Project collection URL incorrect",BASE_PATH + "/projects", collection.getUrl());
        for (Project project : collection.getItems()) {
            Assert.assertEquals("Project instance URL incorrect", BASE_PATH + "/projects/" + project.getName(), project.getUrl());
        }
    }
    ...
    public void verifyProjectInstanceURL() {
        ...
        Assert.assertEquals("Project instance URL incorrect", BASE_PATH + "/projects/" + instance.getName(), instance.getUrl());
    }
